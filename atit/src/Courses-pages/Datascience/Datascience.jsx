                    ...
                    <div className ="container z-3 text-center">
                        ...
                        >
                            <div>
                                ...
                                >
                                    Data <span className ="primary-color">Science</span>
                                </h1>
                                <p
                                ...
                                >
                                    Average Salary For Data Science Engineers In India - Rs.12 Lakhs Per Annum
                                </p>
                                <nav
                                    data-aos="fade-up"
                ...
                <div id="artifical" className ="coursesList">
                    <div className ="container-fluid ">
                        <p className ="fw-semibold display-6 text-center text-capitalize justify-content-center linear-gradient-text pt-5"
                            ...
                            About Data Science Course</p>
                        <div className ="mt-4 text-center text-capitalize g-3">
                            <p data-aos="fade-up" data-aos-duration="600" data-aos-delay="200"> ATIT Data Science Training Will Help You Master And Build Your Data Science Skills With Tools That Matter - Docker Networks, Development Cycles, Puppet, Ansible, Chef, Vagrant, Jenkins, Nagios, And More. Instructors Of ATIT Are Experts At Teaching Both The Essentials And Finer Points Of Data Science Concepts. This Course Will Take Through The Practical Aspects Of Data Science And Help You To Apply These Practices In Real-World Project Examples. Enroll In Our Data Science Certification Course To Transform Your Career Into A Data Science Engineer.
                    ...
                    <section className ="container my-3 pt-3">
                        <div className ="mt-4">
                            ...
                            <p className ="text-center  text-center fw-normal" data-aos="fade-up" data-aos-duration="800"
                                ...
                                offline, we're excited to have you as part of our Data Science community and look forward to
                                helping you
                                advance your career in the world of Data Science</p>
                        </div>
                    </section>
                    <section>
                        <div className ="container-fluid">
                                        ...
                                        <div className ="card-body d-flex flex-column">
                                            <div>
                                                ...
                                                <p className ="about class-content text-center" data-aos="fade-up"
                                                    data-aos-duration="800" data-aos-delay="600">In Today's Digital Age, Data Science Has Become An Essential Practice For Organizations Looking To Streamline Their Software Development And IT Operations. This Online Course Is Designed To Provide You With The Knowledge And Skills Needed To Excel In The World Of Data Science, All From The Comfort Of Your Own Home Or Office.</p>
                                            ...
                                            <div>
                                                ...
                                                <div className ="mt-3">
                                                    <p className ="about class-content text-center"
                                                        ...
                                                        In A World Dominated By Screens And Virtual Interactions, There's Something Special About Coming Together In Person To Learn And Collaborate. Our Data Science Class Is Designed To Provide You With A Hands-On, Immersive Experience That Will Empower You To Become A Data Science Expert.</p>
