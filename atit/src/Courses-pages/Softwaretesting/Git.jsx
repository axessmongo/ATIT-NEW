                    ...
                    <div className ="container z-3 text-center">
                        ...
                        >
                            <div>
                                ...
                                >
                                    G<span className ="primary-color">IT</span>
                                </h1>
                                <p
                                ...
                                >
                                    Average Salary For GIT Engineers In India - Rs.12 Lakhs Per Annum
                                </p>
                                <nav
                                    data-aos="fade-up"
                ...
                <div id="artifical" className ="coursesList">
                    <div className ="container-fluid ">
                        ...
                        <div className ="mt-4 text-center text-capitalize g-3">
                            <p data-aos="fade-up" data-aos-duration="600" data-aos-delay="200">ATIT GIT Training Will Help You Master And Build Your GIT Skills With Tools That Matter - Docker Networks, Development Cycles, Puppet, Ansible, Chef, Vagrant, Jenkins, Nagios, And More. Instructors Of ATIT Are Experts At Teaching Both The Essentials And Finer Points Of GIT Concepts. This Course Will Take Through The Practical Aspects Of GIT And Help You To Apply These Practices In Real-World Project Examples. Enroll In Our GIT Certification Course To Transform Your Career Into A GIT Engineer.
                            </p>
                                        ...
                                        <div className ="card-body d-flex flex-column">
                                            <div>
                                                ...
                                                <p className ="about class-content text-center" data-aos="fade-up"
                                                    data-aos-duration="800" data-aos-delay="600">In Today's Digital Age, GIT Has Become An Essential Practice For Organizations Looking To Streamline Their Software Development And IT Operations. This Online Course Is Designed To Provide You With The Knowledge And Skills Needed To Excel In The World Of GIT, All From The Comfort Of Your Own Home Or Office.
                                                </p>
                                            ...
                                            <div>
                                                ...
                                                <div className ="mt-3">
                                                    <p className ="about class-content text-center"
                                                        ...
                                                        In A World Dominated By Screens And Virtual Interactions, There's Something Special About Coming Together In Person To Learn And Collaborate. Our GIT Class Is Designed To Provide You With A Hands-On, Immersive Experience That Will Empower You To Become A GIT Expert.</p>
