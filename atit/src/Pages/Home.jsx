        ...
        <div className="container">
          ...
          >
            <div className="col-md-4 col-sm-4 col-sx-12 TechnicalSkills-container">
              ...
              >
                ATIT's Placement Assistance Program offers targeted training designed to equip you with essential expertise in
                various critical IT domains, including Software Testing, Software Development, and DevOps, among other
                job-oriented skills.
              </p>
            </div>
            <div className="col-md-4 col-sm-4 col-sx-12 OurMission-container">
              ...
              <p
                ...
                className="pt-2 text-white secondary-text"
              >
                ATIT's core mission is to provide focused training and career guidance, empowering individuals like you to make a
                seamless transition into a successful and fulfilling career within the IT industry.
              </p>
            </div>
            <div
            ...
            >
              ...
              <p
                ...
                className="pt-2 text-white secondary-text"
              >
                Our program is dedicated to refining your skills, providing a strong foundation upon which you can build a
                prosperous career.
              </p>
            </div>
          </div>
            ...
            <div className="col-lg-6">
              <div className="icon-box mb-0">
                ...
                <h1
                  ...
                  data-aos="fade-up"
                  data-aos-duration="1000"
                >Get Placed in Top IT Companies with Our Expert Guidance
                </h1>
              </div>
              <div className="icon-box">
                ...
                <h3
                  ...
                  data-aos-duration="1000"
                >
                  Secure Your Future in the Ever-Evolving Technology Landscape.
                </h3>
              </div>
              ...
              <div className="row mt-5 fs-5 fw-bold">
                <div className="col-6">
                  <div className="d-flex align-items-center" data-aos="fade-left" data-aos-duration="1000">
                    ...
                    <div className="primary-text ps-3">Personalized Guidance</div>
                  </div>
                </div>
                <div className="col-6">
                  <div className="d-flex align-items-center" data-aos="fade-left" data-aos-duration="1000">
                    ...
                    <div className="primary-text ps-3">Industry-Relevant Scenarios</div>
                  </div>
                </div>
              </div>
              <div className="row mt-3 fs-5 fw-bold">
                <div className="col-6">
                  <div className="d-flex align-items-center" data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <div className="primary-text ps-3">Streamlined Process</div>
                  </div>
                </div>
                <div className="col-6">
                  <div className="d-flex align-items-center" data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <div className="primary-text ps-3">Career-Focused Training</div>
                  </div>
                </div>
              </div>
            </div>
