                                ...
                                <li class="nav-item blog-drop position-relative">
                                    ...
                                    <ul class="blog-drop-menu list-unstyled">
                                        <li class="nav-item"><Link class="blog-drop-item nav-link" to="/blog/ultimateGuide">Common Pitfalls In
                                            Interviews</Link></li>
                                        <li class="nav-item"><Link class="blog-drop-item nav-link active" to="/blog/stellarResume">Polishing Up Your Resume</Link></li>
                        ...
                        <div class="right-blog col-lg-8 col-xxl-7 my-3">
                            <div class="p-3">
                                <div data-aos="fade-down" data-aos-duration="700"
                                    ...
                                    <div>
                                        <p class="m-0 text-1 fs-6 fw-medium primary-color">Polishing Up
                                            Your Resume </p>
                                    </div>
                                ...
                                <div class="container my-5 overflow-hidden">
                                    ...
                                    <p class="secondary-text " data-aos="fade-up" data-aos-duration="600">
                                        <span class="fl">U</span>se simple, standard font
                                    ...
                                    <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">Hey there fresh graduates!
                                    </p>
                                    <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">I know you&#39;re probably
                                    ...
                                    <div>
                                        <div class="mb-3" data-aos="fade-up" data-aos-duration="600">
                                            ...
                                            <h1 class="primary-header text-center mb-3" data-aos="fade-up" data-aos-duration="600"> How to craft a stellar resume </h1>
                                        </div>
                                        <div class="mb-3" data-aos="fade-up" data-aos-duration="600">
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">First things first
                                                - formatting.
                                            </p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">Your resume needs
                                                to look professional and be easy to skim.
                                            </p>
                                            <h2 class="secondary-text" data-aos="fade-up" data-aos-duration="600">Use bullet points
                                                instead of long paragraphs of text - this makes the information easy to digest
                                                quickly.</h2>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">Have clear sections
                                                with white space between each one. And watch your alignment - the
                                                content should flow nicely down the page. </p>
                                            <h2 class="secondary-text" data-aos="fade-up" data-aos-duration="600">Now, what should
                                                you actually include on your fresher resume? Here are the key sections to
                                                focus on:</h2>
                                            <p class="secondary-header" data-aos="fade-up" data-aos-duration="600"> 1.
                                                Summary/Objective </p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">This 2-3 line blurb
                                            ...
                                            <p class="secondary-header" data-aos="fade-up" data-aos-duration="600">2. Education</p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">Starting with your
                                            ...
                                            <p class="secondary-header" data-aos="fade-up" data-aos-duration="600">3. Experience</p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">Here are the
                                            ...
                                            <p class="secondary-header" data-aos="fade-up" data-aos-duration="600">4. Skills</p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">A very crucial
                                            ...
                                            <p class="secondary-header" data-aos="fade-up" data-aos-duration="600">5. Certifications
                                            </p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">Got any specialised
                                                certifications related to your industry or role? Pop those in too.</p>
                                            <p class="secondary-header" data-aos="fade-up" data-aos-duration="600">6. Volunteer Work
                                            </p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">If you&#39;ve
                                                ...
                                                experience yet.</p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">Now what should you
                                                avoid or be cautious about including?
                                                Let&#39;s go over some key resume
                                                don&#39;ts:</p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">- Irrelevant
                                                personal details like age, religion, and marital
                                                status. (What are they going to do with
                                                these details? just think…)</p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">- Outdated contact
                                                info - double-check your phone number,
                                                email, and mailing address.</p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">- Spelling or
                                                grammar errors - have multiple people proofread!
                                                (Pro tip: there are many free
                                                tools available to do this)</p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">- Overly designed
                                                formatting with weird text boxes, colours,
                                                charts, etc. Keep it simple!</p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">- Hobbies unless
                                                they directly relate to the job.</p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">- Old or irrelevant
                                                experience from many years ago. Keep it
                                                recent and relevant.</p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">- Lies or
                                                exaggerations! Always be truthful.</p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">- Fancy resume
                                                templates - they can affect readability and ATS compatibility.</p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">- Long paragraphs
                                                or big blocks of text - use short bullets! (like how this blog post is formatted)
                                            </p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">- A generic
                                                objective statement - customise it to each application.</p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">- When you&#39;re
                                                ...
                                                Feel free
                                                to get in touch)</p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">Here are a few more
                                                tips for polishing up your resume:</p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">- Review resume
                                                templates and samples online to see good examples for inspiration.</p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">- Tailor your
                                                resume to each job description - use keywords and relevant skills from the posting.
                                            </p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">- Keep resume
                                                length to 1 page unless you have extensive experience to warrant 2 pages max.</p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">- Use measurable
                                                accomplishments and numbers like &quot;increased social media followers by
                                                15%&quot; not just generic duties.</p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">- Make sure to
                                                proofread repeatedly and fix any typos. Ask others to review.</p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">- Export as a PDF
                                                file - no weird formatting changes will occur.</p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">Whew, we covered a
                                                lot of ground on crafting effective fresher resumes!</p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">I know the job
                                            ...
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">So be diligent
                                                ...
                                                help.</p>
                                            <p class="secondary-text" data-aos="fade-up" data-aos-duration="600">Now go get that
                                                dream job!</p>
                                        </div>
                                    </div>
